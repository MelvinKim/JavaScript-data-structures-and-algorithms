class Graph {
    ...
    //we visit neighbors with the same 'HEIGHT' first
    //We will use a QUEUE => FIFO  (Stack uses => LIFO)
    breadthFirstSearch(starting_vertex) {
        ...
        while(queue.length) {
            //remove the first node|element from queue
